...
%roll (pg. 69)
a_phi1 = -(1/2)*P.rho*((Va_trim)^2)P.S_wing*P.b*P.C_p_p*(P.b/(2*(P.Va0)));
...
%airspeed
a_V1 = (P.rho*Va_trim*P.Swing/P.mass)*(P.C_D_0 + P.C_D_alpha*atan(w_trim/u_trim)...
    + P.C_D_delta_e*delta_e_trim) + (P.rho*P.S_prop/P.mass)*P.C_prop*Va_trim;
a_V2 = (P.rho*P.S_prop/P.mass)*P.C_prop)*(P.K_motor)^2*
