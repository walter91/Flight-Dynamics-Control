...
function sys=mdlDerivatives(t,x,uu, P)
  ...
  % implementation of UAV kinematics and dynamics (see eq.3.14-17, pg 36)
    ...
    pdot = P.Lambda_1*p*q - P.Lambda_2*q*r + P.Lambda_3*ell + P.Lambda_4*n;
    qdot = P.Lambda_5*p*r - P.Lambda_6*(p^2 - r^2) + m/P.Jy;
    rdot = P.Lambda_7*p*q - P.Lambda_1*q*r + P.Lambda_4*ell + P.Lambda_8*n;
